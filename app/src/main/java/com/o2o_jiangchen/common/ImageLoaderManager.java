package com.o2o_jiangchen.common;
...
public class ImageLoaderManager
{
	...
	{
		ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(MyApplication.getApplication()).memoryCacheSize(2 * 1024 * 1024)
