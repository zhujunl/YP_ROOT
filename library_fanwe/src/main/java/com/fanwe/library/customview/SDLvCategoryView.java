...
public class SDLvCategoryView extends SDViewBase {
	...
	private void init() {
		LayoutInflater.from(getContext()).inflate(R.layout.view_category_tab,
				this, true);
		mTvTitle = (TextView) this
				.findViewById(R.id.view_category_tab_tv_title);
		mIvLeft = (ImageView) this.findViewById(R.id.view_category_tab_iv_left);
		mIvRight = (ImageView) this
				.findViewById(R.id.view_category_tab_iv_right);

		View popView = LayoutInflater.from(getContext()).inflate(
				R.layout.pop_category_single_lv, null);
		listView = (ListView) popView
				.findViewById(R.id.pop_category_single_lv_lv);
